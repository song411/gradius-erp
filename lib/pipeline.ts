...
> = {
  ...
  // 처음엔 3일/5일로 잡았는데 실측하니 틀렸다. 접수부터 체결까지 중앙값이
  // 23일(n=178)이고 75%가 27일 안에 끝난다. 5일에 빨간불을 켜면 정상 진행
  // 중인 건까지 전부 빨개져 34건 중 33건이 경고였다 — 늘 빨간 신호등은
  // 신호등이 아니다. 2주 무응답을 경계로 잡는다.
  '체결 전':  { warn: 7, alert: 14, label: '무응답' },
